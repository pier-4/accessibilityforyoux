...
export default function CallToAction() {
  return (
    <section className="flex flex-col items-start text-left sm:items-center sm:text-center gap-6 py-16 md:py-24 px-4 md:px-0">
      <div className="space-y-4 w-full">
        <h2 className="text-3xl sm:text-4xl font-bold text-secondary">
          Good design includes everyone.
        </h2>
        <p className="text-lg text-zinc-500 dark:text-zinc-400 max-w-md sm:mx-auto">
